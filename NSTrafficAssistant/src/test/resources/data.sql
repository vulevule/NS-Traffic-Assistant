--adrese
insert into test.address (id, street, city, zip)values(1, 'Bulevar Vojvode Stepe', 'Beograd', 11000);
insert into test.address (id, street, city, zip)values(2, 'Vuka Karadzica 5', 'Novi Sad', 21000);
--korisnici
insert into test.user (id,type,  name, personal_no, username, password, email, role, activate, user_ticket_type, address_id)
...
--karte
insert into test.ticket (id, serial_no, issue_date, expiration_date, user_type, time_type, 
...
--cenovnik
insert into test.price_list(id,issue_date, activate) values (10, '2018-12-25', true);

--stavke cenovnika
--bus
insert into test.price_item(id, price, traffic_type, time_type, zone, student_discount, senior_discount, handycap_discount, pricelist_id)
